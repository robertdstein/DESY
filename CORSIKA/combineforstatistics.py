					...
					if fullBDT.bdtscore != None:
						...
						if float(result) == float(1):
							...
							if float(ucut) > float(fullBDT.bdtscore) > float(cut):
								...
								if float(fullBDT.channel1.intensity) > float(signalcut):
									passcut = True	
	...
	if hessstatus[i]:
		...
		for rows in [2, 3]:
			...
			if rows == 2:
				...
				plt.savefig("/nfs/astrop/d6/rstein/Hamburg-Cosmic-Rays/report/graphs/cutdistributionhess" + str(i+1) +".pdf")
				...
				plt.savefig("/nfs/astrop/d6/rstein/Hamburg-Cosmic-Rays/CORSIKA/graphs/statshess" + str(i+1) +".pdf")
		...
		plt.savefig("/nfs/astrop/d6/rstein/Hamburg-Cosmic-Rays/CORSIKA/graphs/errorstatshess" + str(i+1) +".pdf")
		plt.savefig("/nfs/astrop/d6/rstein/Hamburg-Cosmic-Rays/report/graphs/DCcounterrorhess" + str(i+1) +".pdf")
