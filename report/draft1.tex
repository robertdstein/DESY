...
Using the sim\textunderscore telarray package, the expected hardware response to the air shower can be simulated. Again, the response of the HESS telescope was selected for simulation, accounting for 
